...
console.log(`Copying ../Angular-ASPNET-Core-CustomersService into modules`);
copyIntoDirectories('../Angular-ASPNET-Core-CustomersService', '.', beginFolder, dirsToIgnore, beginFiles);
